...
public class UtilTest {
    ...
    @Test
    public void detectRepeatsStackedRepeatsTest() 
    {
        IntStream nums = IntStream.of(4, 4, 4, 4, 4);
        assertEquals(3, Util.detectRepeats(nums, 2));
    }
    @Test
    public void detectRepeatsAlternatingValueRepeatsTest() 
    {
        IntStream nums = IntStream.of(4, 3, 4, 3, 4, 3, 4);
        assertEquals(5, Util.detectRepeats(nums, 2));
    }
}
